...
func easyjsonDecodePublicServerConfig22b57fa5(in *jlexer.Lexer, out *PublicServerConfig) {
...
func easyjsonEncodePublicServerConfig22b57fa5(out *jwriter.Writer, in PublicServerConfig) {
	out.RawByte('{')
	first := true
	_ = first
	if !first {
...
func (v PublicServerConfig) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonEncodePublicServerConfig22b57fa5(&w, v)
...
func (v *PublicServerConfig) UnmarshalJSON(data []byte) error {
	...
	easyjsonDecodePublicServerConfig22b57fa5(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *PublicServerConfig) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonDecodePublicServerConfig22b57fa5(l, v)
}
