	...
	for !in.IsDelim('}') {
		...
		case "PKGServers":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v23 pkg.PublicServerConfig
					(v23).UnmarshalEasyJSON(in)
					out.PKGServers = append(out.PKGServers, v23)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "MixServers":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v24 mixnet.PublicServerConfig
					(v24).UnmarshalEasyJSON(in)
					out.MixServers = append(out.MixServers, v24)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonEncodeAddFriendConfig6615c02e(out *jwriter.Writer, in AddFriendConfig) {
	...
	if in.PKGServers == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
		...
		out.RawByte('[')
		for v25, v26 := range in.PKGServers {
			if v25 > 0 {
				out.RawByte(',')
			}
	...
	if in.MixServers == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
		...
		out.RawByte('[')
		for v27, v28 := range in.MixServers {
			if v27 > 0 {
				out.RawByte(',')
			}
